...
<div class="shadow-xl flex flex-col gap-4 bg-white rounded-2xl p-8 h-full relative overflow-hidden">
        ...
        if (isset($_GET['status'])) {
            if ($_GET['status'] == 1) {
                ...
                <div class="flex bg-green-300 px-4 py-1 w-full rounded-lg items-center gap-4 text-slate-800 font-medium">
                    ...
                    <p>Data murid <strong>berhasil</strong> ditambah!</p>
                </div>
                '; 
            } if ($_GET['status'] == 2) {
                echo '
                <div class="flex bg-green-300 px-4 py-1 w-full rounded-lg items-center gap-4 text-slate-800 font-medium">
                    ...
                    <p>Data murid <strong>berhasil</strong> diubah!</p>
                </div>
                ';
            } if ($_GET['status'] == 3) {
                echo '
                <div class="flex bg-red-300 px-4 py-1 w-full rounded-lg items-center gap-4 text-slate-800 font-medium">
                    ...
                    <p>Data murid <strong>berhasil</strong> dihapus!</p>
                </div>
                ';
            } if ($_GET['status'] == 4) {
                echo '
    ...
    <form action="" method="post" class="flex justify-between">
        ...
        <a href="?page=tambah_murid" class="basis-1/4 bg-slate-800 py-2 px-4 rounded-lg text-white font-medium flex gap-2 items-center">
            <i>
    ...
    <table class="pt-4 w-full rounded-t-md overflow-hidden text-sm">
        <thead class="bg-slate-800 text-white">
            <tr>
                ...
                <th class="py-2 px-4 text-start">NISN</th>
                <th class="py-2 px-4 text-start">Nama Murid</th>
                <th class="py-2 px-4 text-start">Kelas</th>
                <th class="py-2 px-4 text-start">Jabatan</th>
            ...
            <?php
                ...
                while ($data = mysqli_fetch_array($query)) {
                    ...
                    echo "<td class='px-4 py-2 flex items-center gap-2'>
                        ...
                        <a href='?page=data_murid&delete=2&id=$data[id]' class='text-red-400'>
                            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='currentColor' class='w-4 h-4'>
